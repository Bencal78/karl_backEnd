...
class RL:
    def __init__(self, clothes, cat_score):
        ...
        self.rl_cat_score = {int(key): value for key, value in cat_score.items()}
    ...
    def prepare_update_value(self):
        ...
        self.rl_cat_score = {str(step): serie.to_dict() for step, serie in self.cat_score_s.items()}
    ...
    def prepare_update_value_d(self, taste):
        ...
        self.rl_cat_score = {step: serie.to_dict() for step, serie in self.cat_score_s.items()}
